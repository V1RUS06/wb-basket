export const Payment = {
  ...
  renderPaymentModal() {
    const cards = this.cards
      .map((card, index) => {
        ...
        } class="check_input" type="radio" name="radio-btn">            
  ...
  renderPayment() {
    ...
    <div class="white_wrapper">
      ...
      <div class="bank_card">
        <img id="img_card_on_payment_container" src="${
          this.cards[this.selectedCardIndex].img_source
        }" alt="bank_card">
              
        <span class="card-span">${
          this.cards[this.selectedCardIndex].card_number
        } ${this.cards[this.selectedCardIndex].card_day}</span>
      </div>
